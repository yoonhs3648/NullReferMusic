...
begin
  foreach v_signature in array array[
    ...
    'public.music_rpc_admin_schedule_run_inserts(text,uuid,integer,integer)',
    'public.music_rpc_admin_schedule_run_jobs(text,uuid)',
    'public.music_rpc_admin_schedule_run_errors(text,uuid)',
    'public.music_rpc_admin_schedule_run_failures(text,uuid,integer,integer)',
