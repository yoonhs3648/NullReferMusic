...
Write-Host '     and set Wi-Fi network profile to Private (not Public).'
Write-Host '  4) If (1) works but Expo Go fails: watch NRM Expo Go window when you reload.'
Write-Host '     Or try: set NRM_EXPO_TUNNEL=1 && scripts\run-expo-go-metro.bat'
Write-Host ''
