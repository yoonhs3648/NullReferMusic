...
<#
.SYNOPSIS
  wav2vec2-base-960h model.onnx → GitHub Release 업로드 (HF 토큰 불필요).

.DESCRIPTION
  library/wav2vec2-base-en/model.onnx 를
  yoonhs3648/NullReferMusic 릴리스 align-wav2vec2-en-v1 에 올립니다.
#>
param(
    [string]$Tag = 'align-wav2vec2-en-v1',
