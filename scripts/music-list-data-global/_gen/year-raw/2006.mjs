export default [
  ...
  "Dem Franchize Boyz feat. Lil Peanut and Charlay|Lean Wit It, Rock Wit It|",
  ...
  "Bubba Sparxxx feat. Ying Yang Twins and Mr. ColliPark|Ms. New Booty|",
  "Sean Paul feat. Keyshia Cole|(When You Gonna) Give It Up To Me|",
  "The Pussycat Dolls|Stickwitu|",
  "T-Pain feat. Mike Jones|I'n N Luv (Wit a Stripper)|",
  ...
  "Cherish feat. Sean Paul Of The YoungBloodZ|Do it to It|",
  ...
  "Dem Franchize Boyz feat. Jermaine Dupri, Da Brat and Bow Wow|I Think They Like Me|",
  "Chris Brown|Say Goodbye|",
  "John Mayer|Waiting on the World to Change|",
  "The Black Eyed Peas|Pump It|",
  "Eminem|When I'm Gone|",
  "Madonna|Hung Up|",
  "Three 6 Mafia feat. Young Buck and Eightball and MJG|Stay Fly|",
  "Keyshia Cole|Love|",
  "Ne-Yo|When You're Mad|",
  "T.I.|Why You Wanna|",
  "Pink|Stupid Girls|",
  "Taylor Hicks|Do I Make you Proud|",
  "Teddy Geiger|For You I Will (Condience)|",
  "Travis|Flowers in the Window|The Invisible Band",
  "Radiohead|There There|Hail to the Thief",
  "Michelle Branch|Breathe|Hotel Paper",
  ...
  "Gwen Stefani|Rich Girl|Love. Angel. Music. Baby.",
  "Jet|Cold Hard Bitch|Get Born",
];
