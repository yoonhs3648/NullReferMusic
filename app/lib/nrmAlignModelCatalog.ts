...
const WAV2VEC2_KO_PACK: NrmAlignModelPackEntry = {
  ...
  assets: [
    { fileName: 'vocab.json', url: `${BASE_KOREAN}vocab.json`, minBytes: 500 },
    { fileName: 'config.json', url: `${BASE_KOREAN}config.json`, minBytes: 500 },
    {
...
const WAV2VEC2_EN_PACK: NrmAlignModelPackEntry = {
  ...
  assets: [
    { fileName: 'vocab.json', url: `${BASE_ENGLISH}vocab.json`, minBytes: 500 },
    { fileName: 'config.json', url: `${BASE_ENGLISH}config.json`, minBytes: 500 },
    {
      fileName: 'preprocessor_config.json',
